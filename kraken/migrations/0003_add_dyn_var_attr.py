...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.dyn_variable_attr'
        db.add_column(u'kraken_request', 'dyn_variable_attr',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Request.dyn_variable_attr_value'
        db.add_column(u'kraken_request', 'dyn_variable_attr_value',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.dyn_variable_attr'
        db.delete_column(u'kraken_request', 'dyn_variable_attr')

        # Deleting field 'Request.dyn_variable_attr_value'
        db.delete_column(u'kraken_request', 'dyn_variable_attr_value')
    ...
    models = {
        ...
        u'kraken.request': {
            'Meta': {'ordering': "['order']", 'object_name': 'Request'},
            'content': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'content_type': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'dyn_variable': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'dyn_variable_attr': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            'dyn_variable_attr_value': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
