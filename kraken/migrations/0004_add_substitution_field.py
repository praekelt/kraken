...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.substitution'
        db.add_column(u'kraken_request', 'substitution',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.substitution'
        db.delete_column(u'kraken_request', 'substitution')
    ...
    models = {
        ...
        u'kraken.request': {
            ...
            'substitution': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
